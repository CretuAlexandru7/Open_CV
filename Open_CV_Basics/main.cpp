...
{    
    ...
    while (!exitProgram) {
        ...
        if (user_key >= ASCII_ZERO && user_key <= ASCII_NINE)
        {
            technique_number = user_key - ASCII_ZERO;
        }
        else if (technique_number == 2 && user_key == MINUS_KEY)
        {
            img_threshold -= 1;
        }
        else if (technique_number == 2 && user_key == PLUS_KEY)
        {
            img_threshold += 1;
        }
